...
from one_shot_sensitivity.data_utils import (
...
class SeqDataJune(torch.utils.data.Dataset):
    def __init__(self, region, meta, X, y_deaths, y_seroprev):
        self.region = region
        self.meta = meta
        self.X = X
        self.y_deaths = y_deaths
        self.y_seroprev = y_seroprev
